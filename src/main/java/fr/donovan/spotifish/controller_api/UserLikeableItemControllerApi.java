...
public class UserLikeableItemControllerApi {
    ...
    public CustomResponse<List<UserLikeableItem>> list() {
        return new CustomResponse<>(HttpStatus.OK.value(), "UserLikeableItemControllerApi - list()", "UserLikeableItem", this.userLikeableItemService.findAll());
    }
    ...
    public CustomResponse<UserLikeableItem> show(@PathVariable String slug) {
        return new CustomResponse<>(HttpStatus.OK.value(), "UserLikeableItemControllerApi - show("+slug+")", "UserLikeableItem", this.userLikeableItemService.getObjectBySlug(slug));
    }
    ...
    public CustomResponse<UserLikeableItem> create(@Valid @RequestBody UserLikeableItemDTO userLikeableItemDTO) {
        return new CustomResponse<>(HttpStatus.CREATED.value(), "UserLikeableItemControllerApi - create()", "UserLikeableItem", userLikeableItemService.persist(userLikeableItemDTO));
    }
    ...
    public CustomResponse<UserLikeableItem> update(@Valid @RequestBody UserLikeableItemDTO userLikeableItemDTO, @PathVariable UserLikeableItemId id) {
        return new CustomResponse<>(HttpStatus.OK.value(), "UserLikeableItemControllerApi - update("+id+")", "UserLikeableItem", userLikeableItemService.persist(userLikeableItemDTO, id));
    }
    ...
    public CustomResponse<Boolean> delete(@PathVariable UserLikeableItemId id) {
        return new CustomResponse<>(HttpStatus.OK.value(), "UserLikeableItemControllerApi - delete("+id+")", "UserLikeableItem", userLikeableItemService.delete(id));
    }
}